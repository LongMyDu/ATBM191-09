...
VALUES ('HSBA0001', 'BN000001', TO_DATE('2001-01-01', 'yyyy-mm-dd'), 'chuan doan 1', 'NV0026', 'K00001', 'CS0001', 'ket luan 1');
INSERT INTO HSBA(MAHSBA,MABN,NGAY,CHANDOAN,MABS,MAKHOA,MACSYT,KETLUAN) 
VALUES ('HSBA0002', 'BN000002', TO_DATE('2001-01-01', 'yyyy-mm-dd'), 'chuan doan 2', 'NV0027', 'K00001', 'CS0001', 'ket luan 2');

select * from HSBA;

--INSERT DATA TO HSBA_DV
INSERT INTO HSBA_DV(MAHSBA,MADV,NGAY,MAKTV,KETQUA)
VALUES ('HSBA0001', 'DV0001',TO_DATE('2001-01-01', 'yyyy-mm-dd'), 'NV0027', 'ket qua dich vu 1');
INSERT INTO HSBA_DV(MAHSBA,MADV,NGAY,MAKTV,KETQUA)
VALUES ('HSBA0001', 'DV0002',TO_DATE('2001-01-01', 'yyyy-mm-dd'), 'NV0028', 'ket qua dich vu 2');
INSERT INTO HSBA_DV(MAHSBA,MADV,NGAY,MAKTV,KETQUA)
VALUES ('HSBA0002', 'DV0001',TO_DATE('2001-01-01', 'yyyy-mm-dd'), 'NV0026', 'ket qua dich vu 3');
INSERT INTO HSBA_DV(MAHSBA,MADV,NGAY,MAKTV,KETQUA)
VALUES ('HSBA0002', 'DV0002',TO_DATE('2001-01-01', 'yyyy-mm-dd'), 'NV0029', 'ket qua dich vu 4');
