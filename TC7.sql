...
EXEC SA_COMPONENTS.CREATE_COMPARTMENT('soyte_policy',100,'DTCS','Dieu tri chuyen sau');
--EXEC SA_COMPONENTS.DROP_COMPARTMENT('soyte_policy',40);
EXEC SA_COMPONENTS.CREATE_COMPARTMENT('soyte_policy',120,'DTNT','Dieu tri noi tru');
--EXEC SA_COMPONENTS.DROP_COMPARTMENT('soyte_policy',60);
EXEC SA_COMPONENTS.CREATE_COMPARTMENT('soyte_policy',140,'DTNGT','Dieu tri ngoai tru');
/
...
--Connect as LBACSYS
EXEC SA_POLICY_ADMIN.REMOVE_TABLE_POLICY('soyte_policy','QLCSYTE_ADMIN','THONGBAO');
/
BEGIN
SA_POLICY_ADMIN.APPLY_TABLE_POLICY(
policy_name   => 'soyte_policy',
