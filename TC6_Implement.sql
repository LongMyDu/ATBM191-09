...
AS SELECT MABN, MACSYT, TENBN,CMND, NGAYSINH, 
...
--DECRYPT_STRING(CMND, MABN + TO_CHAR(NGAYSINH,'yyyy-mm-dd')) AS CMND
--DECRYPT_STRING(TENDUONG, MABN + TO_CHAR(NGAYSINH,'yyyy-mm-dd')) AS 
--DECRYPT_STRING(CMND, MANV + TO_CHAR(NGAYSINH,'yyyy-mm-dd')) AS
commit;

GRANT SELECT ON VW_THONGTINCANHAN_BENHNHAN TO BN000004;
